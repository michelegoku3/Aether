...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::local::install_bulk_local,
            ...
            commands::steam::get_aetheronline,
            commands::steam::set_aetheronline,
            commands::steam::get_aether_showonline,
            commands::steam::set_aether_showonline,
            commands::steam::get_aether_excluded,
            commands::steam::set_aether_excluded,
            commands::steam::get_presence_default_mode,
